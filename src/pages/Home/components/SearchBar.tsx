...
const SearchBar = () => {
  return (
    <div className="mt-2 rounded-full p-2 relative sm:h-12 max-w-sm sm:max-w-lg w-5/6 h-10 bg-gray-100">
      ...
      <input
        ...
        className="sm:py-1 w-5/6 -ml-10 p-0 px-1 outline-none bg-gray-100"
      />
    </div>
  );
};
